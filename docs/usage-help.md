...
编辑器是输入 Markdown 正文的主要区域，现在支持所有 Markdown 语法，还增加了对mermaid图表、数学公式的支持。
- 现在支持的mermaid.js的版本是11.15.0，包括流程图、时序图、甘特图、类图、状态图、实体关系图等所有这个版本支持的图表类型，你可以查看mermaid.js官方文档获取更多信息。

- 支持的数学公式包括行内公式和行间公式两种形式。
